...
import {PackagingCollaboratorService} from '@/controller/service/collaborator/packaging/PackagingCollaboratorService.service';
...
import {InscriptionCollaboratorStateCollaboratorService} from '@/controller/service/collaborator/collaborator/InscriptionCollaboratorStateCollaboratorService.service';


import Edit from '@/components/collaborator/view/collaborator/inscription-collaborator/edit/inscription-collaborator-edit-collaborator.component';
import Create from '@/components/collaborator/view/collaborator/inscription-collaborator/create/inscription-collaborator-create-collaborator.component';
import View from '@/components/collaborator/view/collaborator/inscription-collaborator/view/inscription-collaborator-view-collaborator.component';
...
const List = () => {
    ...
    const service = new InscriptionCollaboratorCollaboratorService();
    ...
    const packagingCollaboratorService = new PackagingCollaboratorService();
    const collaboratorCollaboratorService = new CollaboratorCollaboratorService();
    const inscriptionCollaboratorStateCollaboratorService = new InscriptionCollaboratorStateCollaboratorService();

    useEffect(() => {
        activateSecurityConstraint("InscriptionCollaborator")
        packagingCollaboratorService.getList().then(({data}) => setPackagings(data)).catch(error => console.log(error));
        collaboratorCollaboratorService.getList().then(({data}) => setCollaborators(data)).catch(error => console.log(error));
        inscriptionCollaboratorStateCollaboratorService.getList().then(({data}) => setInscriptionCollaboratorStates(data)).catch(error => console.log(error));
        fetchItems(criteria);
    }, []);
