...
type InscriptionCollaboratorEditCollaboratorType = {
    visible: boolean,
    onClose: () => void,
    ...
    service: InscriptionCollaboratorCollaboratorService,
    t: TFunction
}
const Edit: React.FC<InscriptionCollaboratorEditCollaboratorType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
