...
type InscriptionCollaboratorCreateCollaboratorType = {
    visible: boolean,
    onClose: () => void,
...
const Create: React.FC<InscriptionCollaboratorCreateCollaboratorType> = ({visible, onClose, add, showToast, list, service, t}) => {
