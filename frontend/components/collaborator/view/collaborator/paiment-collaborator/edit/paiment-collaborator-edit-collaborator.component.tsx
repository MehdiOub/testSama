...
type PaimentCollaboratorEditCollaboratorType = {
    visible: boolean,
    onClose: () => void,
    ...
    service: PaimentCollaboratorCollaboratorService,
    t: TFunction
}
const Edit: React.FC<PaimentCollaboratorEditCollaboratorType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
