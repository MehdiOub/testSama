...
type PaimentCollaboratorCreateCollaboratorType = {
    visible: boolean,
    onClose: () => void,
...
const Create: React.FC<PaimentCollaboratorCreateCollaboratorType> = ({visible, onClose, add, showToast, list, service, t}) => {
