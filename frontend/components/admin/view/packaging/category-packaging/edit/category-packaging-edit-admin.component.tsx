...
type CategoryPackagingEditAdminType = {
    visible: boolean,
    onClose: () => void,
    showToast: React.Ref<Toast>,
    selectedItem: CategoryPackagingDto
    update: (item: CategoryPackagingDto) => void,
    list: CategoryPackagingDto[],
    service: CategoryPackagingAdminService,
    t: TFunction
}
const Edit: React.FC<CategoryPackagingEditAdminType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
    ...
    const {
        ...
        parseToIsoFormat,
        adaptDate
        } = useEditHook<CategoryPackagingDto, CategoryPackagingCriteria>({list, selectedItem, onClose, update, showToast,service, t, isFormValid})
