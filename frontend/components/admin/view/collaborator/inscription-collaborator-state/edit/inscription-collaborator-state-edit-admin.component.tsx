...
type InscriptionCollaboratorStateEditAdminType = {
    visible: boolean,
    onClose: () => void,
    showToast: React.Ref<Toast>,
    selectedItem: InscriptionCollaboratorStateDto
    update: (item: InscriptionCollaboratorStateDto) => void,
    list: InscriptionCollaboratorStateDto[],
    service: InscriptionCollaboratorStateAdminService,
    t: TFunction
}
const Edit: React.FC<InscriptionCollaboratorStateEditAdminType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
    ...
    const {
        ...
        parseToIsoFormat,
        adaptDate
        } = useEditHook<InscriptionCollaboratorStateDto, InscriptionCollaboratorStateCriteria>({list, selectedItem, onClose, update, showToast,service, t, isFormValid})
