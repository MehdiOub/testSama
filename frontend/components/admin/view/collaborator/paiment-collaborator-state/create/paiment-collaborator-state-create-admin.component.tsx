...
type PaimentCollaboratorStateCreateAdminType = {
    visible: boolean,
    onClose: () => void,
    add: (item: PaimentCollaboratorStateDto) => void,
    showToast: React.Ref<Toast>,
    list: PaimentCollaboratorStateDto[],
    service: PaimentCollaboratorStateAdminService,
    t: TFunction
}
const Create: React.FC<PaimentCollaboratorStateCreateAdminType> = ({visible, onClose, add, showToast, list, service, t}) => {
    ...
    const emptyItem = new PaimentCollaboratorStateDto();
        const {
            ...
            saveItem,
            formateDate
        } = useCreateHook<PaimentCollaboratorStateDto, PaimentCollaboratorStateCriteria>({list, emptyItem, onClose, add, showToast,service, isFormValid})
