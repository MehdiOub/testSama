...
type PaimentCollaboratorStateEditAdminType = {
    visible: boolean,
    onClose: () => void,
    showToast: React.Ref<Toast>,
    selectedItem: PaimentCollaboratorStateDto
    update: (item: PaimentCollaboratorStateDto) => void,
    list: PaimentCollaboratorStateDto[],
    service: PaimentCollaboratorStateAdminService,
    t: TFunction
}
const Edit: React.FC<PaimentCollaboratorStateEditAdminType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
    ...
    const {
        ...
        parseToIsoFormat,
        adaptDate
        } = useEditHook<PaimentCollaboratorStateDto, PaimentCollaboratorStateCriteria>({list, selectedItem, onClose, update, showToast,service, t, isFormValid})
