...
type ProjectStateEditAdminType = {
    visible: boolean,
    onClose: () => void,
    showToast: React.Ref<Toast>,
    selectedItem: ProjectStateDto
    update: (item: ProjectStateDto) => void,
    list: ProjectStateDto[],
    service: ProjectStateAdminService,
    t: TFunction
}
const Edit: React.FC<ProjectStateEditAdminType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
    ...
    const {
        ...
        parseToIsoFormat,
        adaptDate
        } = useEditHook<ProjectStateDto, ProjectStateCriteria>({list, selectedItem, onClose, update, showToast,service, t, isFormValid})
