...
type TechnologyCreateAdminType = {
    visible: boolean,
    onClose: () => void,
    add: (item: TechnologyDto) => void,
    showToast: React.Ref<Toast>,
    list: TechnologyDto[],
    service: TechnologyAdminService,
    t: TFunction
}
const Create: React.FC<TechnologyCreateAdminType> = ({visible, onClose, add, showToast, list, service, t}) => {
    ...
    const emptyItem = new TechnologyDto();
        const {
            ...
            saveItem,
            formateDate
        } = useCreateHook<TechnologyDto, TechnologyCriteria>({list, emptyItem, onClose, add, showToast,service, isFormValid})
