...
public class PackagingRestAdmin {
    ...
    @Operation(summary = "find by categoryPackaging code")
    @GetMapping("categoryPackaging/code/{code}")
    public List<PackagingDto> findByCategoryPackagingCode(@PathVariable String code){
        return findDtos(service.findByCategoryPackagingCode(code));
    }
    @Operation(summary = "delete by categoryPackaging code")
    @DeleteMapping("categoryPackaging/code/{code}")
    public int deleteByCategoryPackagingCode(@PathVariable String code){
        return service.deleteByCategoryPackagingCode(code);
    }
