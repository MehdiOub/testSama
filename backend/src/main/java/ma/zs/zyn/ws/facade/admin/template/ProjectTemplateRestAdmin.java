...
public class ProjectTemplateRestAdmin {
    ...
    @Operation(summary = "find by template id")
    @GetMapping("template/id/{id}")
    public List<ProjectTemplateDto> findByTemplateId(@PathVariable Long id){
        return findDtos(service.findByTemplateId(id));
    }
    @Operation(summary = "delete by template id")
    @DeleteMapping("template/id/{id}")
    public int deleteByTemplateId(@PathVariable Long id){
        return service.deleteByTemplateId(id);
    }
    @Operation(summary = "find by project id")
    @GetMapping("project/id/{id}")
    public List<ProjectTemplateDto> findByProjectId(@PathVariable Long id){
